# TODO:  Thin is not running under sudo, fix try removed -u vagrant, trying to install as sudo
...
$script = <<SCRIPT
  ...
  # install thin
  sudo -u vagrant -H gem install thin
  ...
  # run thin and daemonize
  thin -p 8080 -P thin/thin.pid -l thin/thin.log -d start
SCRIPT
